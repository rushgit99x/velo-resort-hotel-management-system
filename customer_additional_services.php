...
// Define available services with their charges and descriptions
$available_services = [
    'restaurant' => ['name' => 'Restaurant', 'description' => 'Access to on-site dining with a variety of cuisines', 'charge' => 25.00],
    'room_service' => ['name' => 'Room Service', 'description' => 'Food and beverage delivery to your room', 'charge' => 15.00, 'note' => '+ menu price'],
    'laundry' => ['name' => 'Laundry', 'description' => 'Professional laundry and dry-cleaning services', 'charge' => 10.00],
    'telephone' => ['name' => 'Telephone Service', 'description' => 'Local and international call access', 'charge' => 0.50, 'note' => 'per minute'],
    'key_issuing' => ['name' => 'Automatic Key Issuing', 'description' => 'Self-service key issuance for quick check-in', 'charge' => 5.00],
    'club_facility' => ['name' => 'Club Facility', 'description' => 'Access to exclusive club amenities (pool, gym, lounge)', 'charge' => 50.00]
];
...
// Fetch customer reservations (only pending or confirmed)
try {
    $stmt = $pdo->prepare("
...
<head>
    ...
    <title>Additional Services - Customer Dashboard</title>
